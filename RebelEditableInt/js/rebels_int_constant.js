...
app.registerExtension({
    name: "Comfy.RebelsIntConstant",
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "RebelsIntConstantNode") {
            ...
            nodeType.prototype.onDrawForeground = function(ctx) {
                ...
                const textDropOffset = 20; 

                ctx.fillStyle = "#ffffff";
                ctx.font = `bold ${dynamicNameSize}px sans-serif`;
                ctx.textAlign = "center";
                ctx.shadowBlur = 0; 
                ctx.fillText(displayName, w / 2, startY + dynamicNameSize + 10 + textDropOffset);
                ...
                const numberY = startY + dynamicNameSize + 20 + textDropOffset + (dynamicFontSize * 0.7);
